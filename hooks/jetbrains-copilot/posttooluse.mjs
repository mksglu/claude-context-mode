...
import { readStdin, getSessionId, getSessionDBPath, getProjectDir, JETBRAINS_OPTS } from "../session-helpers.mjs";
...
const DEBUG_LOG = join(DEBUG_DIR, "posttooluse-debug.log");
