 ...
 *
 * Triggered when the host is about to compact the conversation.
...
import { readStdin, getSessionId, getSessionDBPath, JETBRAINS_OPTS } from "../session-helpers.mjs";
...
const DEBUG_DIR = join(homedir(), ".config", "JetBrains", "context-mode");
const DEBUG_LOG = join(DEBUG_DIR, "precompact-debug.log");
