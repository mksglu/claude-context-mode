...
export function createRoutingBlock(t: ToolNamer, options: RoutingBlockOptions = {}): string {
...
export function createReadGuidance(t: ToolNamer): string {
